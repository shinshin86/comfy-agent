...
describe("Colab kit seed targets", () => {
  it("applies --seed to imported presets for at least 37 of 41 kits", async () => {
    ...
    expect(supportedKits.size).toBeGreaterThanOrEqual(37);
    expect(supportedKits.size).toBe(40);
