...
| [`./minimax_h3_fast/`](./minimax_h3_fast/) | Starter | A100 | FastH3 Preview v1 four-forward T2VA with mandatory 90%-sparse VSA (44.40 GB; Draft ComfyUI pin + source-built CUDA kernel; no FL2VA/Ref2VA) |
