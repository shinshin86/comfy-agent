...
The machine-readable catalog currently contains **39 kits**: 28 verified,
...
| [`./krea2_h3/`](./krea2_h3/) | Verified E2E | A100 | Combo kit: Krea 2 Turbo 864x480 keyframes + MiniMax H3 I2V/R2V with native stereo audio (82.08 GB; H3 territory-restricted upstream license—review runtime region; see `recipes/krea2-h3/`) |
