# Colab cell: set up ComfyUI and download SDXL Turbo weights.
...
#
# SDXL Turbo is distributed by Stability AI under the Stability AI Non-Commercial
# Research Community License (research / non-commercial use).
# Reference workflow: https://comfyanonymous.github.io/ComfyUI_examples/sdturbo/
# Weights:           https://huggingface.co/stabilityai/sdxl-turbo
...
TURBO_BASE = "https://huggingface.co/stabilityai/sdxl-turbo/resolve/main"
!wget -nc -O {WORKSPACE}/models/checkpoints/sd_xl_turbo_1.0_fp16.safetensors {TURBO_BASE}/sd_xl_turbo_1.0_fp16.safetensors
