# Colab cell: set up ComfyUI and download Stable Diffusion XL base 1.0 weights.
...
#
# SDXL base 1.0 is distributed by Stability AI under the OpenRAIL++ license.
# Reference workflow: https://comfyanonymous.github.io/ComfyUI_examples/sdxl/
...
SDXL_BASE = "https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0/resolve/main"
!wget -nc -O {WORKSPACE}/models/checkpoints/sd_xl_base_1.0.safetensors {SDXL_BASE}/sd_xl_base_1.0.safetensors
