...
| `PROMPT_REJECTED`         | 3    | ComfyUI rejected the submitted workflow during prompt validation; correct the reported node inputs and rerun                                                       | `status`, `error`, `node_errors`                                                                                                                                            |
